/* Continuum Prompt 40 (Prompt 39A Section 5): the error catalogue source. The
   ...
   the current element is "Patient does not have an Alberta PHN" where Y means no
...
export const ROWS = [
  {
    ...
    board_code: "121023",
    element_name: "Alberta PHN",
    confidence: 0.85,
    legacy_note: "Legacy 2007 return file wording (7.02) has inverted polarity versus the current \"Patient does not have an Alberta PHN\" element (Y means no PHN). Mapped to the element only; never seed a value or a correction.",
