...
- 50a Decision 1 is
  RELEASED-from-53-hold. Platform GO
  still requires a Craig or Hermes
  named path. Do not invent live
...
Prompt 62 booking placeholder this
note says the Calendly link closes:

- [../62/STOPS.md](../62/STOPS.md)

Prompt 65 live holding-page gate in
this checkout (no separately titled
"gate future at launch" line):
