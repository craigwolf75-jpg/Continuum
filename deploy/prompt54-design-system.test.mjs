/* Prompt 54 design-system / surface-standard honesty gate.
   ...
   Prompt 54 is the governing surface-standard number. The 51-design-system
...
ok("continuum_tokens.css names Prompt 54 as the governing surface-standard number",
  /Prompt 54 is the governing surface-standard number/.test(tokens));
